...
const gameOfFives = (bavarianBeerBears,scandinavianSchöllers) => bavarianBeerBears.filter(el => el === 5).length === scandinavianSchöllers.filter(el => el === 5).length ? "Drinks All Round! Free Beers on Bjorg!" : "Uh Oh! Bjorg's a donut! No beer for anyone!"  
